...
sklm: {
    ...
    permissionDeny: "拒绝规则",
    permissionDenyDesc: "始终拒绝的 JSON glob，即使处于全自动模式也会生效。插件只能追加规则，不能放宽你的设置。",
    permissionDenyPlaceholder: "{ \"tools\": [\"Bash\"], \"paths\": [\"**/.env\", \"~/.ssh/**\"], \"commands\": [\"rm -rf\"] }",
    permissionDenySaveError: "无法保存拒绝规则，请检查 JSON。",
    autoReview: "自动审批",
  ...
  plugins: {
    ...
    permissions: {
      ...
      "agent.permission.deny": "添加始终拒绝的权限规则",
    ...
    permissionHelp: {
      ...
      "agent.permission.deny": "允许插件添加工具、路径和命令 glob，命中后始终拒绝。不能放宽你的设置。",
      "desktop.control":
